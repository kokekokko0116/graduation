        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('mastertest.mypage') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('mastertest.mypage')" :active="request()->routeIs('mastertest.mypage')">
                        {{ __('Mypage') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('mastertest.index')" :active="request()->routeIs('mastertest.index')">
                        {{ __('CardList') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('mastertest.create')" :active="request()->routeIs('mastertest.create')">
                        {{ __('Edit') }}
                    </x-nav-link>
                </div>
            </div>
